...
export default async function FullPageImageView(props: { photoId: string }) {
    const idAsNum = Number(props.photoId);
    if(Number.isNaN(idAsNum)) throw new Error("Id Not Found");
    ...
    return (
        <div className="flex w-full h-full min-w-0">
            <div className="flex-grow flex items-center justify-center min-w-0">
                <img src={image.url} alt={props.photoId} className="object-contain max-w-full max-h-full" />
            </div>
